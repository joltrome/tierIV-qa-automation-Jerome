...
test.describe('Footer Validation Tests', () => {
  ...
  test('TC003-03: Verify all footer link texts are retrieved', async () => {
  ...
  // ===== Same-Tab Legal Links Tests =====

  test('TC003-05: Verify CONTACT link is visible and clickable', async () => {
  ...
  test('TC003-07: Verify COOKIE POLICY link is visible and clickable', async () => {
    test.setTimeout(60000); // Increase timeout for navigation with waits
  ...
  test('TC003-10: Verify MEDIA KIT link opens in new tab', async ({ page, context }) => {
  ...
  test('TC003-11: Verify LinkedIn link opens in new tab', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC003-12: Verify Twitter/X link opens in new tab with correct URL', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC003-13: Verify YouTube opens in new tab with correct URL', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC003-14: Verify Facebook opens in new tab with correct URL', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC003-15: Verify Instagram link opens in new tab', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC003-16: Verify GitHub link opens to autowarefoundation/autoware', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
...
test.describe('Footer Validation - Edge Cases', () => {
  ...
  test('TC003-17: Verify footer is accessible via keyboard navigation', async ({ page }) => {
  ...
  test('TC003-18: Verify footer links work after page reload', async () => {
    // Scroll to footer
    await footer.scrollToFooter();
  ...
  test('TC003-19: Verify footer responsive on mobile viewport', async ({ page }) => {
    // Set mobile viewport
  ...
  test('TC003-20: Verify footer appears on different pages', async () => {
  ...
  test('TC003-21: Verify social media links have correct attributes', async () => {
  ...
  test('TC003-22: Verify footer maintains structure across languages', async () => {
  ...
  test('TC003-23: Verify Twitter/X link URL is correct', async () => {
    // Check if Twitter/X link exists
    const isTwitterVisible = await footer.isTwitterLinkVisible();
  ...
  test('TC003-24: Verify YouTube link is correct', async () => {
    // Check if YouTube link exists
    const isYoutubeVisible = await footer.isYoutubeLinkVisible();
  ...
  test('TC003-25: Verify Privacy Policy page loads correctly', async () => {
  ...
  test('TC003-26: Verify Twitter/X link URL discovery', async () => {
