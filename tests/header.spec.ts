...
test.describe('Header Navigation Tests', () => {
  ...
  // ===== Same-Tab Navigation Tests =====

  test('TC001-04: Verify About Us link navigates correctly and preserves language', async () => {
  ...
  test('TC001-05: Verify Open Source link navigates correctly and preserves language', async () => {
    // Get initial language
    const initialLanguage = homePage.getCurrentLanguage();
  ...
  test('TC001-06: Verify Our Products link navigates correctly and preserves language', async () => {
    // Get initial language
    const initialLanguage = homePage.getCurrentLanguage();
  ...
  test('TC001-07: Verify Alliance link navigates correctly and preserves language', async () => {
    // Get initial language
    const initialLanguage = homePage.getCurrentLanguage();
  ...
  test('TC001-08: Verify Our Team link navigates correctly and preserves language', async () => {
    // Get initial language
    const initialLanguage = homePage.getCurrentLanguage();
  ...
  test('TC001-09: Verify Media link navigates correctly and preserves language', async () => {
    // Get initial language
    const initialLanguage = homePage.getCurrentLanguage();
  ...
  test('TC001-10: Verify Services link opens in new tab', async ({ context }) => {
  ...
  test('TC001-11: Verify Careers link opens in new tab', async ({ page, context }) => {
    test.setTimeout(60000); // Increase timeout for new tab operations
  ...
  test('TC001-12: Verify logo is clickable and returns to homepage', async () => {
  ...
  test('TC001-13: Verify hamburger menu is visible and clickable', async () => {
  ...
  test('TC001-14: Verify homepage main heading is visible', async () => {
...
test.describe('Header Navigation - Edge Cases', () => {
  ...
  test('TC001-15: Verify page is responsive to window resize', async ({ page }) => {
  ...
  test('TC001-16: Verify back navigation works correctly', async () => {
    // Get initial URL
  ...
  test('TC001-17: Verify page loads without console errors', async ({ page }) => {
  ...
  test('TC001-18: Verify navigation links are clickable', async () => {
